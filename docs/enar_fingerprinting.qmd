...
<span style="color:#F56600;"> But...we know when people are walking </span>
...
res_500 %>% 
  ...
  scale_fill_manual(values = c("#A45C98", "#86C8BC", "#F1C400")) +
  theme(legend.position = "none") + 
  labs(x = "Model", y = "Rank 1 Accuracy (%)", title = "Model choices", subtitle = "ADEPT, subgroups of n = 500, 3 min of data per ppt.") 
